...
FIELD_META = {
    ...
    "sys_protocols_seen":  ("", "none", "mdi:format-list-numbered", "Protocols Seen"),
    "sys_protocols_hint":  ("", "none", "mdi:lightbulb-outline", "Protocol Filter Hint"),
    "sys_capture_status":  ("", "none", "mdi:record-circle-outline", "Support Capture"),
