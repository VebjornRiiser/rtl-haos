...
FIELD_META = {
    ...
    "sys_cfg_blacklist":    ("", "none", "mdi:playlist-remove", "Config: Blacklist"),
    "sys_cfg_whitelist":    ("", "none", "mdi:playlist-check", "Config: Whitelist"),
    "sys_cfg_sensors":      ("", "none", "mdi:eye-settings", "Config: Main Sensors"),
    ...
    "mics_vout":            ("V", "voltage", "mdi:flash", "MiCS Voltage"),
    "mics_ratio":           ("ratio", "none", "mdi:gas-cylinder", "MiCS-5524 Ratio"),
    "mq2_ratio":            ("ratio", "none", "mdi:fire", "MQ-2 Ratio"),
    ...
    # --- Diagnostics ---
    # "nouse":                ("flag", "none", "mdi:timer-off-outline", "No Usage Flag"),
    # "leaknow":              ("flag", "none", "mdi:water-alert", "Leak (Now)"),
    # "leak":                 ("flag", "none", "mdi:water-alert", "Leak (Current)"),
    # "backflow":             ("flag", "none", "mdi:water-alert", "Back Flow"),
    # "EndpointID":           ("", "none", "mdi:identifier", "Endpoint ID"),
    # "EndpointType":         ("", "none", "mdi:format-list-bulleted-type", "Endpoint Type"),
    # "MeterType":            ("", "none", "mdi:counter", "Meter Type"),
    # "PacketCRC":            ("", "none", "mdi:check-network", "Packet CRC"),
    # "ProtocolID":           ("", "none", "mdi:protocol", "Protocol ID"),
    # "protocol":             ("", "none", "mdi:protocol", "Protocol"),
    # "type":                 ("", "none", "mdi:format-list-bulleted-type", "Meter Type"),
    # "msg_type":             ("", "none", "mdi:message-processing", "Message Type"),
    # "checksum":             ("", "none", "mdi:check-network", "Checksum"),
    # "crc":                  ("", "none", "mdi:check-network", "CRC Check"),
    # "segment_crc":          ("", "none", "mdi:check-network", "Segment CRC"),
    # "phy":                  ("code", "none", "mdi:wrench", "Physical Status"),
    # "physical_status":      ("code", "none", "mdi:wrench", "Physical Status"),
    # "battery_low":          ("", "battery", "mdi:battery-alert", "Low Battery"),
    # "battery_ok":           ("", "battery", "mdi:battery-heart", "Battery Status"),
    # "battery":              ("", "battery", "mdi:battery", "Battery Status"),
    # "flags":                ("code", "none", "mdi:flag", "Status Flags"),
    # "unkn1":                ("", "none", "mdi:help-circle-outline", "Unknown 1"),
    # "unkn2":                ("", "none", "mdi:help-circle-outline", "Unknown 2"),
    # "unkn3":                ("", "none", "mdi:help-circle-outline", "Unknown 3"),
}